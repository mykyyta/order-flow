...
from orders.models import DelayedNotificationLog
...
def test_orders_created_delayed_is_idempotent_per_user_and_order():
    from orders.notifications import _orders_created_delayed
    ...
    with patch("orders.notifications.send_tg_message", return_value=True):
