"""Order notification helpers (Telegram)."""
...
from apps.orders.models import DelayedNotificationLog
from apps.orders.utils import generate_order_details, send_tg_message
...
def _orders_created_delayed(*, orders: list["Order"]) -> bool:
    users_to_notify = NotificationSetting.objects.filter(
        notify_order_created=True,
